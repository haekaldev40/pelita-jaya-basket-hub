        ...
        <div className="flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center gap-3 hover-scale">
            ...
            <div className="hidden md:block">
              <h1 className="text-xl font-bold text-navy">Pelita Jaya</h1>
              <p className="text-xs text-navy/70">Basketball Club</p>
            </div>
          </a>
          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="text-sm font-medium text-navy hover:text-orange transition-colors duration-300 relative group"
              >
                {link.name}
            ...
            <div className="flex flex-col gap-4">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-base font-medium text-navy hover:text-orange transition-colors py-2"
                >
                  {link.name}
                </a>
              ))}
